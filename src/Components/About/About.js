      ...
      <Container maxWidth="xl">
        ...
        >
          <Grid container justifyContent="center">
            <Grid item xl={10} md={6} className="title" justifyContent="flex-start">
              <Fade left>
                <h1>GABRIEL CHOW</h1>
                <p>
                  {" "}
            ...
            {/* <Grid item xl={2} md={6} className="title" justifyContent="flex-end">
              <Fade right>
                <img src={img} alt="pic" />
              </Fade>
            </Grid> */}
        ...
        <Grid item xs={6} className="aboutColor moblie">
          <div className="aboutText">
            <Slide left>
              <h1>About Me</h1>
              <p>
                I was working in interior design, before I learning Front-end
                Web developer, this is my drawing of my job.
              </p>
            </Slide>
          </div>
        </Grid>
